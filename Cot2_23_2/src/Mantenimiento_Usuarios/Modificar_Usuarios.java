...
public class Modificar_Usuarios extends javax.swing.JFrame {
    ...
    public Modificar_Usuarios() {
        initComponents();
        co.Bloquear_objetos_modificar(jTextField1, jTextField2, jTextField3,
                jTextField4, jTextField5, jTextField6, jPasswordField1,
                jButton9, jButton10);
        co.Combo_nivel(jComboBox1);
    ...
    public void modifica(java.awt.event.ActionEvent e) {
        if (jTextField1.getText().equals("")
            ...
            if (md.modificar_usuarios(jTextField1.getText(), jTextField2.getText(),
                     jTextField3.getText(),
                    jTextField5.getText(),
                    jTextField6.getText(), jTextField4.getText(), jPasswordField1.getText())) {
                ...
                co.Limpiar_Objetos_modificar(jTextField1, jTextField2,
                        jTextField3, jTextField4, jTextField6, jTextField5, jPasswordField1);
                co.Bloquear_objetos_modificar(jTextField1, jTextField2, jTextField3,
    ...
    private void initComponents() {
        ...
        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/IMAGENES/ajustes.png"))); // NOI18N
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jComboBox1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (jTextField3.getText().equals("")) {
            ...
            if (md.buscar_id(jTextField3.getText()) == 1) {
                ...
                co.Desbloquear_objetos_modificar(jTextField1, jTextField2, 
                ...
                co.Limpiar_Objetos_modificar(jTextField1, jTextField2, jTextField3,
...
//proceso que asigna al campo texto la opion que el usuario selecciona
        jTextField5.setText("" + jComboBox1.getSelectedItem());
